...
interface DeleteInvestmentCategoryI {
...
const DeleteInvestmentCategory = ({
  category,
  onClose,
}: DeleteInvestmentCategoryI) => {
  const { deleteCategory, deleteLoading } = useInvestmentStore();
  ...
  return (
    <motion.div
      key="delete-investment-category-modal"
      initial="initial"
      animate="animate"
      exit="exit"
...
export default DeleteInvestmentCategory;
