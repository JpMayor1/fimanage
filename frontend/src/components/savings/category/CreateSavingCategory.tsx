...
interface CreateSavingCategoryI {
  onClose: () => void;
}
...
const CreateSavingCategory = ({ onClose }: CreateSavingCategoryI) => {
  const { createCategories, createLoading } = useSavingStore();
...
export default CreateSavingCategory;
