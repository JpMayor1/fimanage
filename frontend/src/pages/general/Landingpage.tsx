    ...
    <div className="text-white h-screen flex flex-col font-sans overflow-y-scroll no-scrollbar">
      ...
      <header className="flex justify-between items-center px-8 py-6 border-b border-gray-700">
        <motion.h1
          ...
          className="text-3xl font-extrabold tracking-wide text-yellow drop-shadow-lg"
        >
          Fimanage
        </motion.h1>
        ...
        >
          ...
          <Link
            to="/auth/login"
            className="px-4 py-2 rounded-lg border border-yellow text-yellow hover:bg-yellow hover:text-black transition"
          >
            Login
          </Link>
          <Link
            to="/auth/register"
            className="px-4 py-2 rounded-lg bg-yellow text-black hover:opacity-90 transition"
          >
            Register
          </Link>
        </motion.nav>
